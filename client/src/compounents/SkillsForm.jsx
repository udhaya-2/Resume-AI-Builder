    ...
    return(
        <div className="space-y-4">
            ...
            <div className="flex gap-2">
                <input type="text" placeholder="Enter a skill (e.g., JavaScript , Project Managemet)"
                className="flex-1 px-4 py-2 text-sm" onChange={(e) => setNewSkill(e.target.value)}
                value={newSkill}
                onKeyDown={handleKyPress}/>
            ...
            <div className="bg-blue-50 p-3 rounded-lg ">
             <p className="text-sm text-blue-800"> 
                <strong>Tips:</strong> Add 8-12 relevent skills. Include both technical skills (progamming language ,tools) and  
                soft skills (leardership , communication).
             </p>
            </div>
        </div>
    )

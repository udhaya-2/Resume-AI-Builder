...
const Features = () => {
    ...
    return (
        ...
        <Title title='Bulid your resume' description='Our streamlind process helps you
        create a professional resume in minutes withh intelligent AI-powered tools  and  features'/>

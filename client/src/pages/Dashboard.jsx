...
import { Contact, FilePenLineIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloudIcon, XIcon , UploadCloud, XOctagon, Delete, LoaderCircleIcon} from "lucide-react"
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-4">
        <p className="text-2xl font-medium mb-6 bg-gradient-to-r from-slate-700 
        bg-clip-text text-transparent sm-hidden">Welcome, ramana</p>
        <div className="flex gap-4">
          ...
          rounded-lg gap-2 ttext-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
        ...
        {showCreateResume && (
          ...
          z-10 flex items-center justify-center">
            <div onClick={e => e.stopPropagation()} className=" relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
              ...
              rounded hover:bg-green-600 transition-colors">Create Resume</button>
        ...
        )}
        {
          ...
          z-10 flex items-center justify-center">
              ...
              rounded hover:bg-green-600 transition-colors flex items-center justify-center">
        ...
        {editResumeId && (
          ...
          z-10 flex items-center justify-center">
            <div onClick={e => e.stopPropagation()} className=" relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
              ...
              px-4 py-2 mb-4 focus:border-green-600 ring-green-600" required />
              <button className="w-full py-2 bg-green-600 text-white 
              rounded hover:bg-green-600 transition-colors">Upload</button>
              <XIcon className="absolute top-4 right-4 text-slate-400
              hover:text-slate-600 cursor-pointer transition-colors" onClick={() => {

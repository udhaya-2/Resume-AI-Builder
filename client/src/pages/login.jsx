...
const Login = () => {
  ...
  return (
    <div className="flex item-center justify-center max-h-screen bg-gray-50">
      <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white mt-15">
